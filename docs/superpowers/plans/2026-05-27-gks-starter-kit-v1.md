...
**Goal:** Build and publish v1 of the GKS Starter Kit — a mkdocs-Material site on GitHub Pages containing the vignette template, contribution flow, four reader-facing pages, and one polished worked-example vignette (BRCA Exchange + VRS) — per `docs/superpowers/specs/2026-05-27-gkm-starter-kit-design.md`.
...
**Spec:** `docs/superpowers/specs/2026-05-27-gkm-starter-kit-design.md`
...
```bash
cd /Users/lbabb/Development/gks/gkm-starter-kit
python3 -m venv .venv
...
site_url: https://ga4gh.github.io/gkm-starter-kit/  # Update once canonical URL is decided
repo_url: https://github.com/ga4gh/gkm-starter-kit  # Update once repo is on GitHub
repo_name: ga4gh/gkm-starter-kit
...
The [vignette authoring guide](https://github.com/ga4gh/gkm-starter-kit/tree/main/docs/vignettes/_template) has examples of strong vs weak "Why this matters" paragraphs — worth a read before you start.
...
body:
  - type: markdown
    attributes:
      value: |
        Thanks for proposing a vignette! This form captures the basics so a maintainer can triage. After triage, you (or a helper) will draft the full vignette in a follow-up PR — see [the contribution guide](https://ga4gh.github.io/gkm-starter-kit/contribute/) for the structure.
...
contact_links:
  - name: Contribution guide
    url: https://ga4gh.github.io/gkm-starter-kit/contribute/
...
- **AC1 — Site reachable at stable URL:** After `git push origin main`, watch the Actions tab until the publish workflow's first run completes. Open the resulting GitHub Pages URL (default `https://<org>.github.io/gkm-starter-kit/`) in a browser. Confirm it returns HTTP 200 and shows the landing page.
...
- **AC5 end-to-end — contribution path works:**
    - Visit `https://github.com/<org>/gkm-starter-kit/issues/new/choose`. Confirm "Propose a vignette" appears as an option and that opening it shows the structured form with all required fields.
