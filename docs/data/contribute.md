...
**How to start:** Read the [Data overview](index.md) to see the packaging pattern and the partner model. To propose a bundle from your resource, open an issue and a maintainer will help you scope its producer-specific format.
